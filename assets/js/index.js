...
const products = [
  ...
  },
  {
    ...
    description: "Our red chilli powder is made from carefully selected, high-quality chillies, offering a perfect balance of vibrant color and bold heat. Whether you’re looking to spice up your curries, marinades, or sauces, this finely ground powder brings rich flavor and a fiery kick to every dish. Known for its consistent quality and potency, it’s a must-have in any kitchen. Ideal for both home cooks and chefs, our red chilli powder enhances not just the taste, but also the visual appeal of your food.",
    images: [
      "assets/images/cp.jpg",
      "assets/images/cp2.webp"
    ],
    features: [
      { feature: "Color", value: "Bright to deep red" },
      { feature: "Form", value: "Finely ground powder" },
      { feature: "Aroma", value: "Pungent, spicy, and slightly smoky" },
      { feature: "Flavor", value: "Hot, sharp, and robust" },
      { feature: "Heat Level", value: "15,000–50,000 SHU (varies by variety)" },
      { feature: "Processing", value: "Sun-dried chillies, then ground" },
      { feature: "Moisture", value: "8-12%" },
      { feature: "Seed Content", value: "Contains both skin and seeds" },
      { feature: "Uses", value: "Curries, marinades, pickles, sauces, pizza, pasta" },
      { feature: "Origin", value: "India (major producer), also China, Turkey" },
      { feature: "Health Benefits", value: "Rich in capsaicin, boosts metabolism, antioxidant" }
    ]
  },

  {
    title: "Turmeric",
    description: "Turmeric is a vibrant yellow-orange spice known for its earthy flavor and numerous health benefits. Grown primarily in India, turmeric is a key ingredient in many culinary dishes and traditional medicines. It is valued for its anti-inflammatory properties and is often used in powdered form for cooking, as well as in supplements and skincare products.",
    images: [
      "assets/images/turmeric1.jfif",
      "assets/images/turmeric2.jpeg"
    ],
    features: [
      { feature: "Color", value: "Bright yellow to deep orange" },
      { feature: "Form", value: "Whole dried rhizome or ground powder" },
      { feature: "Aroma", value: "Earthy, slightly bitter, and peppery" },
      { feature: "Flavor", value: "Warm, bitter, and slightly pungent" },
      { feature: "Curcumin Content", value: "2-5%" },
      { feature: "Processing", value: "Boiled, dried, and ground" },
      { feature: "Moisture", value: "6-12%" },
      { feature: "Length", value: "3-7 cm (rhizome)" },
      { feature: "Uses", value: "Culinary, medicinal, cosmetic, dye" },
      { feature: "Origin", value: "India (major producer)" },
      { feature: "Health Benefits", value: "Anti-inflammatory, antioxidant, supports digestion" }
    ]
  },
  {
    title: "Coriander Seeds",
    description: "Coriander seeds are the dried seeds of the coriander plant, known for their warm, nutty, and citrusy flavor. Widely used in cooking and traditional medicine, they are valued for their digestive and anti-inflammatory properties. Coriander seeds are commonly ground into a spice or used whole in various cuisines around the world.",
    images: [
      "assets/images/dhaniya1.jfif",
      "assets/images/dhaniya2.jfif"
    ],
    features: [
      { feature: "Color", value: "Light brown to yellowish-brown" },
      { feature: "Form", value: "Whole dried seeds or ground powder" },
      { feature: "Aroma", value: "Warm, spicy, and citrusy" },
      { feature: "Flavor", value: "Mild, nutty, slightly sweet with citrus notes" },
      { feature: "Essential Oil Content", value: "0.1-1%" },
      { feature: "Processing", value: "Sun-dried and cleaned" },
      { feature: "Moisture", value: "8-12%" },
      { feature: "Seed Size", value: "3-5 mm diameter" },
      { feature: "Uses", value: "Culinary (whole or ground), pickling, spice blends" },
      { feature: "Origin", value: "India, Morocco, Russia, and others" },
      { feature: "Health Benefits", value: "Aids digestion, anti-inflammatory, rich in antioxidants" }
    ]
  },
  {
    title: "Chilli Flakes",
    description: "Chilli flakes are crushed dried red chillies, known for their spicy heat and vibrant color. Commonly used as a condiment or spice in various cuisines, they add a fiery kick to dishes. Chilli flakes are valued for their capsaicin content, which provides heat and potential health benefits such as metabolism boosting and pain relief.",
    images: [
      "assets/images/chilliflakes1.jfif",
      "assets/images/chilliflakes2.webp"
    ],
    features: [
      { feature: "Color", value: "Bright to deep red with visible seeds" },
      { feature: "Form", value: "Crushed dried red chillies (flakes)" },
      { feature: "Aroma", value: "Pungent, spicy, and slightly smoky" },
      { feature: "Flavor", value: "Hot, sharp, and robust" },
      { feature: "Heat Level", value: "Varies by variety, typically 15,000–50,000 SHU" },
      { feature: "Processing", value: "Sun-dried, then crushed" },
      { feature: "Moisture", value: "8-12%" },
      { feature: "Seed Content", value: "Contains both skin and seeds" },
      { feature: "Uses", value: "Pizza, pasta, curries, marinades, pickles, sauces" },
      { feature: "Origin", value: "India (major producer), also China, Turkey" },
      { feature: "Health Benefits", value: "Rich in capsaicin, boosts metabolism, antioxidant" }
    ]
  }
